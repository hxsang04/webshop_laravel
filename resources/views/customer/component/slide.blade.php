            ...
            <div class="banner-items">
              <a href="#" class="banner-items-thumbnail position-relative">
                ...
                <div class="banner-items-content position-absolute">
                  ...
                  <span class="banner-items-content-link">View Discounts
                    <svg class="banner-items-content-arrow-icon" xmlns="http://www.w3.org/2000/svg" width="20.2"
