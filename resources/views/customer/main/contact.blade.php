                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="contact-form-list mb-20">
                                    ...
                                    <input class="contact-form-input" name="firstname" id="email" placeholder="Email" type="text">
                                </div>
                            </div>
                            <div class="col-12">
                ...
                <div class="contact-info">
                    ...
                    <div class="contact-info-item">
                        ...
                        <ul class="contact-info-social d-flex">
                            ...
                            <li class="contact-info-social-list">
                                <a class="contact-info-social-icon" target="_blank" href="https://twitter.com">
                            ...
                            <li class="contact-info-social-list">
                                <a class="contact-info-social-icon" target="_blank" href="https://www.instagram.com">
                            ...
                            <li class="contact-info-social-list">
                                <a class="contact-info-social-icon" target="_blank" href="https://www.youtube.com">
