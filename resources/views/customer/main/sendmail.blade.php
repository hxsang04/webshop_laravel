        ...
        <th valign="top" style="mso-line-height-rule: exactly;">
          <center style="width: 100%;">
            <table border="0" width="600" cellpadding="0" cellspacing="0" align="center"
              style="width: 600px; min-width: 600px; max-width: 600px; margin: auto;" class="email-container"
              role="presentation">
              <tbody>
                <tr>
                  <th valign="top" style="mso-line-height-rule: exactly;">
                                ...
                                <tr>
                                  <th class="column_logo"
                                    ...
                                    <a href="https://us.tens.co/tools/emails/click/order-confirmation/1/logo/link?url=https%3A%2F%2Fus.tens.co"
                                      ...
                                      <img
                                        src="https://d1oo2t5460ftwl.cloudfront.net/api/file/XYXyqUiJSciMOcMhTwc0/convert?fit=max&amp;w=192"
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center"
                              ...
                              <tbody>
                                ...
                                <tr id="section-1468267" class="section introduction">
                                  <th style="mso-line-height-rule: exactly; padding: 13px 52px;" bgcolor="#ffffff">
                                    ...
                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;"
                                      align="center">We've got your order! Your world is about to look a whole lot
                                      better.</p>
                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;"
                                      align="center">We'll drop you another email when your order ships.</p>
                                  </th>
                                </tr>
                                ...
                                <tr id="section-1468270" class="section order_number_and_date">
                                  <th style="mso-line-height-rule: exactly; padding: 13px 52px;" bgcolor="#ffffff">
                                    <h2
                                      ...
                                      align="center">
                                      <span data-key="1468270_order_number">Order No.</span> {{$order->id}}
                                    </h2>
                                    <p class="muted"
                                      ...
                                      align="center">{{date_format($order->created_at, 'd/m/Y')}}</p>
                                  </th>
                                </tr>
                                ...
                                <tr id="section-1468271" class="section products_with_pricing">
                                  ...
                                  <!-- end Bold 1 -->
                                  <th style="mso-line-height-rule: exactly; padding: 13px 52px;" bgcolor="#ffffff">
                                    <table class="table-inner" cellspacing="0" cellpadding="0" border="0" width="100%"
                                      style="min-width: 100%;" role="presentation">
                                      <tbody>
                                        <tr>
                                          <th class="product-table" style="mso-line-height-rule: exactly;"
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0" width="100%"
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          ...
                                                          <th class="line-item-description"
                                                            ...
                                                            <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                              ...
                                                              <span class="muted"
                                                                ...
                                                                <br>Size: {{$orderDetail->productDetail->size}}
                                                              </span>
                                                            </p>
                                                          </th>
                                                          ...
                                                          <th class="right line-item-qty" width="1"
                                                          ...
                                                          <th class="right line-item-line-price" width="1"
                                                            ...
                                                            <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                              align="right">
                                                              ${{number_format($orderDetail->productDetail->product->price_sale, 2)}}
                                                            </p>
                                                          </th>
                                                        </tr>
                                                      </tbody>
                                        ...
                                        <tr>
                                          <th class="pricing-table"
                                            style="mso-line-height-rule: exactly; padding: 13px 0;" bgcolor="#ffffff"
                                            valign="top">
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%"
                                              style="min-width: 100%;" role="presentation">
                                              ...
                                              <tbody>
                                                  <!-- Subtotal -->
                                                  <tr>
                                                    <th class="table-title" data-key="1468271_subtotal"
                                                      ...
                                                      align="left" bgcolor="#ffffff" valign="top">Subtotal</th>
                                                    <th class="table-text"
                                                      ...
                                                      align="right" bgcolor="#ffffff" valign="middle">${{number_format($order->total_price, 2)}}</th>
                                                  </tr>
                                                <tr>   
                                                  ...
                                                  <th class="table-title"
                                                    ...
                                                    <span data-key="1468271_discount"
                                                      style="font-weight: bold;">Discount</span> ({{$order->discount}}%) 
                                                  </th>
                                                  <th class="table-text"
                                                    style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; width: 35%; padding: 6px 0;"
                                                    align="right" bgcolor="#ffffff" valign="middle">- ${{ number_format(0, 2) }}</th>
                                                    <!-- End Discount -->
                                                </tr>
                                                ...
                                                <tr>
                                                  <th class="table-title"
                                                    style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: bold; color: #666363; width: 65%; padding: 6px 0;"
                                                    align="left" bgcolor="#ffffff" valign="top">Shipping Fee/ &amp;
                                                    Signed (4-9 days)</th>
                                                  <th class="table-text"
                                                    style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; width: 35%; padding: 6px 0;"
                                                    align="right" bgcolor="#ffffff" valign="middle">$0.00</th>
                                                </tr>
                                                <!--End Shipping fee -->

                                                <!-- Total Price -->
                                                <tr class="pricing-table-total-row">
                                                  <th class="table-title" data-key="1468271_total"
                                                    style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: bold; color: #666363; width: 65%; padding: 6px 0;"
                                ...
                                <!-- <tr id="section-1468272" class="section payment_info">
                                  <th style="mso-line-height-rule: exactly; padding: 13px 52px;" bgcolor="#ffffff">
                                    <table class="table-inner" cellspacing="0" cellpadding="0" border="0" width="100%"
                                      ...
                                      <!-- <tbody>
                                        <tr>
                                          <th colspan="2" style="mso-line-height-rule: exactly;" bgcolor="#ffffff"
                                            valign="top">
                                        ...
                                        <!-- <tr>
                                          <th class="table-title"
                                            ...
                                            align="left" bgcolor="#ffffff" valign="top">
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%"
                                              style="min-width: 100%; font-weight: bold;" role="presentation">
                                              <tbody>
                                    ...
                                    <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center"
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <th width="50%" class="column_1_of_2 column_bill_to "
                                            style="mso-line-height-rule: exactly;" align="left" bgcolor="#ffffff"
                                            valign="top">
                                            <table align="center" border="0" width="100%" cellpadding="0"
                                              cellspacing="0" style="min-width: 100%;" role="presentation">
                                              <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                  <th class="billing_address "
                                                    ...
                                                    align="left" bgcolor="#ffffff" valign="top">
                                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                      align="left">{{$order->user_fullname}}<br>
                                                      {{$order->user_phonenumber}}<br>
                                                      {{$order->user_address}}<br>
                                                      {{$order->user_postcode}}<br>
                                                      {{$order->user_country}}<br>
                                                    </p>
                                                  </th>
                                                </tr>
                                              </tbody>
                                          ...
                                          <th width="50%" class="column_2_of_2 column_ship_to "
                                            style="mso-line-height-rule: exactly;" align="right" bgcolor="#ffffff"
                                            valign="top">
                                            <table align="center" border="0" width="100%" cellpadding="0"
                                              cellspacing="0" style="min-width: 100%;" role="presentation">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  <th class="shipping_address "
                                                    ...
                                                    align="right" bgcolor="#ffffff" valign="top">
                                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                      align="right">{{$order->payment == 'cod' ? 'Cash On Delivery' : $order->payment }}
                                                    </p>
                                                  </th>
                                                </tr>
                                              </tbody>
                                  ...
                                  <th style="mso-line-height-rule: exactly; padding: 26px 52px;" bgcolor="#ffffff">
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%" role="presentation">
                                      <tbody>
                                        <tr>
                                          <th
                                            style="mso-line-height-rule: exactly; border-top-width: 2px; border-top-color: #dadada; border-top-style: solid;"
                                            bgcolor="#ffffff" valign="top">
                                          </th>
                                        </tr>
                                      </tbody>
                                ...
                                <tr id="section-1468276" class="section closing_text">
                                  <th data-key="1468276_closing_text" class="text"
                                    ...
                                    align="center" bgcolor="#ffffff">
                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                      align="center">If you need help with anything please don't hesitate to drop us an
                                      email: eshop.stable@gmail.com</p>
                                  </th>
                                </tr>
                                <!-- END SECTION: Closing Text -->
                                <tr data-id="link-list">
                                  <td class="menu_bar menu_bar_6"
                                    style="mso-line-height-rule: exactly; padding: 26px 0;" bgcolor="#ffffff">
                                    <table class="table_menu_bar" border="0" width="100%" cellpadding="0"
                                    ...
                                    <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center"
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <th width="50%" class="column_1_of_2 column_social_block "
                                            ...
                                            <table align="center" border="0" width="100%" cellpadding="0"
                                              ...
                                              <tbody>
                                                <tr style="" align="center">
                                                  <th class="column_footer_title " width="100%"
                                                    ...
                                                    <p data-key="section_footer_title"
                                                      ...
                                                      align="center">Let's follow us!</p>
                                                  </th>
                                                </tr>
                                                <!-- Social heading : END -->
                                                ...
                                                <!-- Store Address : BEGIN -->
                                                <tr style="" align="center">
                                                  <th class="column_shop_social_icons " width="100%"
                                                    style="mso-line-height-rule: exactly; padding-right: 5%;"
                                                    align="center" bgcolor="#ffffff" valign="top">
                                                    <a class="social-link" href="https://www.facebook.com/tens"
                                                      target="_blank" title="Facebook"
                                                      style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; text-align: center;">
                                                      <img width="32" class="social-icons" alt="Facebook"
                                                    ...
                                                    <a class="social-link" href="https://twitter.com/tens"
                                                      target="_blank" title="Twitter"
                                                      style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; text-align: center;">
                                                      <img width="32" class="social-icons" alt="Twitter"
                                                    ...
                                                    <a class="social-link" href="https://instagram.com/tens/"
                                                      target="_blank" title="Instagram"
                                                      style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; text-align: center;">
                                                      <img width="32" class="social-icons" alt="Instagram"
                                                        src="https://orderlyemails.com/instagram_3.png"
                                                        style="width: 32px; height: auto !important; vertical-align: middle; text-align: center; padding: 6px 6px 0;">
                                                    </a>
                                                    <a class="social-link" href="https://www.youtube.com/c/tens-co"
                                                      target="_blank" title="YouTube"
                                                      style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; text-align: center;">
                                                      <img width="32" class="social-icons" alt="YouTube"
                                          ...
                                          <th width="50%" class="column_2_of_2 column_shop_block "
                                            ...
                                            <table align="center" border="0" width="100%" cellpadding="0"
                                              ...
                                              <tbody>
                                                <tr style="" align="center">
                                                  <th class="column_shop_block2 " data-key="section_shop_block2"
                                                    width="100%"
                                ...
                                <tr>
                                  <th data-id="store-info" style="mso-line-height-rule: exactly;" bgcolor="#ffffff">
                                    <table border="0" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                      ...
                                      <tbody>
                                        <tr>
                                          <th class="column_shop_block1 " width="100%"
                                            ...
                                            align="center" bgcolor="#ffffff">
                                            <a href="#"
                                              target="_blank" data-key="section_shop_block1"
                                              style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; font-weight: 400; text-transform: none;">eshop.stable.com</a>
                                          </th>
                                        </tr>
                                        <!-- Store Website : END -->
                                      </tbody>
